...
<div class="card">
    ...
    <div class="card-content">
      ...
      <div class="content Element de jeu">
        <p><strong> Elements de jeu :  </Strong> {{ElementsJeu}}  </p>
      </div>
